...
\years{2019}\underline{Miao Cai}, Steven E. Rigdon, Daire Jansson, Leslie Hinyard, Zhengmin Qian. ``Validating Two Multiple Indicators and Three Single Numeric Score Charlson or Elixhauser Comorbidity Indices Among the Population of Shanxi, China", 已投稿至\emph{Medical Care}.\\
...
\section*{学术协会会员}
\noindent
- \emph{美国统计协会(American Statistical Association, ASA)}: 会员,\\
- \emph{美国公共卫生协会(American Public Health Association, APHA)}: 会员,\\
- \emph{中国留美经济学会(The Chinese Economists Society, CES)}: 会员,\\
- \emph{中国卫生政策与管理学会(China Health Policy and Management Society, CHPAMS)}: 会员.
...
\noindent
\years{2019 $-$}\emph{International Journal of Geriatric Psychiatry},\\
\years{2018 $-$}\emph{BMJ Open},\\
\years{2017 $-$}\emph{International Journal for Equity in Health}.
