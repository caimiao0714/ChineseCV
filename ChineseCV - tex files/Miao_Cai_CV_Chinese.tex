...
\begin{document}
	...
	\begin{enumerate}[leftmargin=0ex,itemsep=1ex]
		...
		\item Lin, X., Green, J.C., Xian, H., \underline{Cai, M.}, Skrzypek, J., Tao, H.$^\ast$ ``Holiday and weekend effects on mortality for acute myocardial infarction in Shanxi, China from 2014 to 2017". Forthcoming.\emph{International Journal of Public Health}. (SSCI Q2, IF: 2.373, rank: 42/164).
	...
	\begin{enumerate}[leftmargin=0ex,itemsep=1ex]
		...
		\item \textbf{Cai, M.}, Mehdizadeh, A., Hu, Q., Alamdar Yazdi, M., Vinel, A., Davis, K., Megahed, F., Rigdon, S.$^\ast$. ``Hierarchical Point Process Models for Recurring Safety Critical Events for Commercial Truck Drivers". 已投稿至\emph{Journal of the American Statistical Association}. (SCI Q1, IF: 3.989, rank: 4/124)
