...
\section*{工作经验}
\noindent
\years{2019-2020}\emph{生物统计师 } 美国退伍军人事务部圣路易斯分部，临床流行病学研究中心\\
\years{2017-2019}\emph{研究助理 } 美国国家自然科学基金全额资助，圣路易斯大学公共卫生与社会正义学院\\
\years{2016}\emph{数据分析师 } 中国湖北武汉雕龙软件公司\\
...
\section*{编程技能}
\noindent
\years{R}每日R使用者，熟练使用以下包: \texttt{Rmarkdown}, \texttt{tidyverse}, \texttt{data.table}, \texttt{shiny}, \texttt{brms}$\dots$\\
...
\years{SQL}超过20亿条美国退伍军人事务部门诊和住院病历首页数据管理和统计建模\\
